...
public class PerfMonDataEntriesTest {
    ...
    public void testExcludeHostAndMetricOtherThanMethod() {
        ...
        dataEntries.add(new String[] {"1455366135623", "9128", "192.168.0.12 CPU"});
        dataEntries.add(new String[] {"1455366145623", "1232", "192.168.0.12 CPU"});
        dataEntries.add(new String[] {"1455366145623", "3212", "192.168.0.15 CPU"});
